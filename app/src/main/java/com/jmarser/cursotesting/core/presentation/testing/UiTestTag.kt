...
object UiTestTag {
    ...
    /** CHECKOUT */
    const val CHECKOUT_STATE_LOADING = "checkout_state_loading"
    const val CHECKOUT_PROGRESS_INDICATOR = "checkout_progress_indicator"
    const val CHECKOUT_STATE_FAILED = "checkout_state_failed"
    const val CHECKOUT_FAILED_MESSAGE = "checkout_failed_message"
    const val CHECKOUT_FAILED_BUTTON = "checkout_failed_button"
    const val CHECKOUT_STATE_SUCCESS = "checkout_state_success"
    const val CHECKOUT_SUCCESS_TEXT_CONFIRMED = "checkout_success_text_confirmed"
    const val CHECKOUT_SUCCESS_TEXT_ETA_MINUTES = "chackout_success_text_eta_minutes"
    const val CHECKOUT_SUCCESS_TEXT_PRICE = "checkout_success_text_price"
    const val CHECKOUT_STATE_IDLE = "checkout_state_idle"
    const val CHECKOUT_IDLE_TEXT_TOTAL = "checkout_idle_text_total"
    const val CHECKOUT_OUTLINEDTEXTFIELD_NAME = "checkout_outlinedtextfield_name"
    const val CHECKOUT_OUTLINEDTEXTFILED_TEXT_NAME = "checkout_outlinedtextfield_text_name"
    const val CHECKOUT_OUTLINEDTEXTFIELD_ADDRESS = "checkout_outlinedtextfield_address"
    const val CHECKOUT_OUTLINEDTEXTFILED_TEXT_ADDRESS = "checkout_outlinedtextfield_text_address"
    const val CHECKOUT_OUTLINEDTEXTFIELD_EMAIL = "checkout_outlinedtextfield_email"
    const val CHECKOUT_OUTLINEDTEXTFILED_TEXT_EMAIL = "checkout_outlinedtextfield_text_email"
    const val CHECKOUT_TEXT_CART_EMPTY = "checkout_text_cart_empty"
    const val CHECKOUT_CART_NOT_EMPTY_BUTTON = "checkout_cart_not_empty_button"
}